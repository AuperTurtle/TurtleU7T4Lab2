...
public class WordScramble
{
    ...
    public static String scrambleWord(String word) {
        for (int i = 0; i < word.length() - 1; i++) {
            if (String.valueOf(word.charAt(i)).equals("A") && !String.valueOf(word.charAt(i + 1)).equals("A")) {
                word = word.substring(0, i) + String.valueOf(word.charAt(i + 1)) + "A" + word.substring(i + 2);
                i++;
            }
        }
        return word;
